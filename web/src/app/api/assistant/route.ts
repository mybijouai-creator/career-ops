...
- setProfile {"name":"…","email":"…","location":"…","roles":["AI Engineer","ML Engineer"],"compMin":70000,"compMax":95000,"currency":"EUR","remote":"Remote (EU)","seniority":"Senior","portfolioUrl":"janesmith.dev","linkedin":"linkedin.com/in/jane","github":"github.com/jane","twitter":"x.com/jane"} — PROPOSE the user's profile; the app shows a confirm card and ONLY on their OK writes config/profile.yml (merge-safe — it never clobbers their other fields) AND seeds the free scanner from the roles. Emit only fields you're confident about (most come from their CV — portfolio/LinkedIn/GitHub/X links included, if the CV has them). NEVER write a profile they didn't approve.
